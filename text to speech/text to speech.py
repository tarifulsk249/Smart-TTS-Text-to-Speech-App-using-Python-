...
def speak_text(language=None):
    ...
    if text == "":
        status_label.configure(text="⚠️ Please enter some text!", text_color="orange")
        return
...
# Title
title_label = ctk.CTkLabel(app, text="🗣️ Text to Speech Converter", font=("Arial Rounded MT Bold", 22))
